export const listStyles = `
  :host {
    display: block;
    --list-border-color: var(--color-neutral-300);
    --list-item-padding: var(--spacing-3);
    --list-item-hover-bg: var(--foreground-inverse);
    --list-item-active-bg: var(--primary-default);
    --list-item-active-color: var(--primary-default);
  }
