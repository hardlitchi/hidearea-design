        ...
        "
          ...
          "
            ...
            <div style="padding: 1.5rem;">
              <h3
                style="margin: 0 0 0.5rem 0; color: var(--color-neutral-900, #111827);"
              >
                Card ${i + 1}
              </h3>
              <p
              ...
              >
                This is a card component in a grid layout demonstrating
                real-world usage.
              </p>
            </div>
          </div>
...
export const DashboardLayout: Story = {
  render: () => html`
    <ha-grid columns="12" gap="4">
      <div
        style="grid-column: span 12; background: var(--color-primary-100, #e0e7ff); padding: 2rem; border-radius: 0.5rem; text-align: center;"
      >
        <h2 style="margin: 0; color: var(--color-primary-900, #312e81);">
          Dashboard Header
        </h2>
      </div>
      <div
        style="grid-column: span 8; background: var(--color-neutral-100, #f3f4f6); padding: 1.5rem; border-radius: 0.5rem;"
      >
      ...
      <div
        style="grid-column: span 4; background: var(--color-neutral-100, #f3f4f6); padding: 1.5rem; border-radius: 0.5rem;"
      >
      ...
      <div
        style="grid-column: span 4; background: var(--color-success-100, #d1fae5); padding: 1.5rem; border-radius: 0.5rem;"
      >
        <h4 style="margin: 0; color: var(--color-success-900, #064e3b);">
          Widget 1
        </h4>
      </div>
      <div
        style="grid-column: span 4; background: var(--color-warning-100, #fef3c7); padding: 1.5rem; border-radius: 0.5rem;"
      >
        <h4 style="margin: 0; color: var(--color-warning-900, #78350f);">
          Widget 2
        </h4>
      </div>
      <div
        style="grid-column: span 4; background: var(--color-danger-100, #fee2e2); padding: 1.5rem; border-radius: 0.5rem;"
      >
        <h4 style="margin: 0; color: var(--color-danger-900, #7f1d1d);">
          Widget 3
        </h4>
      </div>
    </ha-grid>
