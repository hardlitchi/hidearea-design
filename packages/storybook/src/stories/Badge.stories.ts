...
export const OutlinedVariants: Story = {
  render: () => html`
    ...
    >
      ...
      <ha-badge variant="secondary" style-variant="outlined"
        >Secondary</ha-badge
      >
  ...
  render: () => html`
    ...
    >
      ...
      <ha-button variant="outline">
        Messages
        <ha-badge variant="success" pill size="sm" style="margin-left: 0.5rem;"
          >12</ha-badge
        >
      </ha-button>
      <ha-button variant="ghost">
        Alerts
        <ha-badge variant="warning" pill size="sm" style="margin-left: 0.5rem;"
          >3</ha-badge
        >
      </ha-button>
    </div>
...
export const StatusBadges: Story = {
  render: () => html`
    <div style="display: flex; flex-direction: column; gap: 1rem;">
      ...
      <div style="display: flex; gap: 0.5rem; align-items: center;">
        <ha-badge variant="secondary" style-variant="soft" pill
          >Archived</ha-badge
        >
  ...
  render: () => html`
    ...
    >
      <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          <ha-badge variant="primary" style-variant="filled">Primary</ha-badge>
          <ha-badge variant="secondary" style-variant="filled"
            >Secondary</ha-badge
          >
          <ha-badge variant="success" style-variant="filled">Success</ha-badge>
          <ha-badge variant="warning" style-variant="filled">Warning</ha-badge>
      ...
      <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          <ha-badge variant="primary" style-variant="outlined"
            >Primary</ha-badge
          >
          <ha-badge variant="secondary" style-variant="outlined"
            >Secondary</ha-badge
          >
          <ha-badge variant="success" style-variant="outlined"
            >Success</ha-badge
          >
          <ha-badge variant="warning" style-variant="outlined"
            >Warning</ha-badge
          >
          <ha-badge variant="error" style-variant="outlined">Error</ha-badge>
          <ha-badge variant="info" style-variant="outlined">Info</ha-badge>
      ...
      <div>
        ...
        <div style="display: flex; flex-direction: column; gap: 0.5rem;">
          <ha-badge variant="primary" style-variant="soft">Primary</ha-badge>
          <ha-badge variant="secondary" style-variant="soft"
            >Secondary</ha-badge
          >
          <ha-badge variant="success" style-variant="soft">Success</ha-badge>
          <ha-badge variant="warning" style-variant="soft">Warning</ha-badge>
