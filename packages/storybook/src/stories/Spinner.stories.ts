...
export const Colors: Story = {
  render: () => {
    ...
    const colors: Array<'primary' | 'success' | 'warning' | 'error' | 'info' | 'neutral'> = [
      'primary',
      'success',
      'warning',
      'error',
...
export const Variants: Story = {
  render: () => {
    ...
    const variants: Array<'circular' | 'dots' | 'pulse'> = ['circular', 'dots', 'pulse'];
...
export const AllVariantsShowcase: Story = {
  render: () => {
    ...
    const variants: Array<'circular' | 'dots' | 'pulse'> = ['circular', 'dots', 'pulse'];
    const colors: Array<'primary' | 'success' | 'error'> = ['primary', 'success', 'error'];
